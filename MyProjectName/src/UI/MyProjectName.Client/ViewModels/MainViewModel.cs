namespace MyProjectName.Client.ViewModels;

using System.Collections.ObjectModel;
using MyProjectName.Application.Interfaces.CQRS;
using MyProjectName.Application.UseCases.Person;
using MyProjectName.Application.UseCases.Person.Commands.Create;
using MyProjectName.Application.UseCases.Person.Commands.Delete;
using MyProjectName.Application.UseCases.Person.Commands.Update;
using MyProjectName.Application.UseCases.Person.Queries.GetPerson;
